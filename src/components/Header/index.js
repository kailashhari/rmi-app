        ...
        <Toolbar sx={{
          ...
          <Box sx={{
            ...
            {pages.map((page) => (
              ...
              style={{
                ...fontStyles.navlinks,
                color: location.pathname === `/${page.route}` ? colors.primary : colors.light,
              }}>
                <Link to={`/${page.route}`} state={{prevPath: location.pathname}} style={{
                  color: 'inherit',
                  textDecoration: 'none'
                }}>{page.text}</Link>
                {location.pathname === `/${page.route}` && <Indicator active={location.pathname === `/${page.route}`}/>}
              </NavItem>
            ))}  


            <a href="https://www.youtube.com/c/RMIRoboticsandMachineIntelligenceNITT" style={{
              height: '36px',
              marginBlock: 'auto',
              cursor: 'pointer'
            }}>
